...
public class ListaPedidosClienteActivity extends AppCompatActivity {
    ...
    public void povoarPedidos(){
        ...
        cursor=db.rawQuery("SELECT * FROM PEDIDO WHERE ClienteID = " + Integer.parseInt(usuario) + " and Status = 'Pronto'", null);
        ...
        cursor=db.rawQuery("SELECT * FROM PEDIDO WHERE ClienteID = " + Integer.parseInt(usuario) + " and Status = 'Confirmado'", null);

        if (cursor.moveToFirst()){
            do{
                Log.w(TAG,"Cliente5 "+auxID);
        ...
        cursor=db.rawQuery("SELECT * FROM PEDIDO WHERE ClienteID = " + Integer.parseInt(usuario) + " and Status = 'Enviado'", null);

        if (cursor.moveToFirst()){
            do{
                Log.w(TAG,"Cliente6 "+auxID);
        ...
        Log.w(TAG,"Cliente");
        cursor=db.rawQuery("SELECT * FROM PEDIDO WHERE ClienteID = " + Integer.parseInt(usuario) + " and Status = 'Entregue'", null);
        Log.w(TAG,"Cliente2");
